...
import com.quan.wechat.converter.OrderForm2OrderDTOConverter;
...
import com.quan.wechat.service.BuyerService;
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String, String>> create(@Valid OrderForm orderForm, BindingResult bindingResult) {
        ...
        if (CollectionUtils.isEmpty(orderDTO.getOrderDetailList())) {
            log.error("【创建订单】购物车不能为空" ,orderDTO.getOrderDetailList());
            throw new SellException(ResultEnum.CART_EMPTY.getCode(),"购物车为空");
        }
